...
describe('ProposalsService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(proposals_service_1.ProposalsService);
        jest.clearAllMocks();
    });
    ...
    describe('createProposal', () => {
        ...
        it('should require targetItemId and baseVersion for update proposals', async () => {
            mockPrismaService.tripMember.findUnique.mockResolvedValue(mockRegularMember);
            await expect(service.createProposal(tripId, memberUserId, {
                type: 'UPDATE_TIME',
                payload: { startMinute: 540 },
    ...
    describe('acceptProposal', () => {
        ...
        it('should reject a member trying to accept a proposal', async () => {
            mockPrismaService.tripMember.findUnique.mockResolvedValue(mockRegularMember);
            await expect(service.acceptProposal(tripId, memberUserId, 'proposal-1')).rejects.toThrow(common_1.ForbiddenException);
        });
    });
...
//# sourceMappingURL=proposals.service.spec.js.map